...
import com.liyongzhen.teamup.model.ChatModel;
...
//        mRecyclerView.addItemDecoration(new DividerItemDecoration(this, DividerItemDecoration.VERTICAL));
    ...
    private void setTitleWithUserName(String id) {
        Query query = FirebaseDatabase.getInstance().getReference().child("profiles").child(id);
    ...
    private void fetchChatData() {
        ...
        Query query = FirebaseDatabase.getInstance().getReference().child("user-messages").child(uId).child(friend.getId());
