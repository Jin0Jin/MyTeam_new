...
public class ProfileActivity extends BaseActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewSportname = (TextView) findViewById(R.id.textViewSport);
        imageViewLevel = (ImageView) findViewById(R.id.imageViewLevel);
    ...
    private void fillUIFields(Profile profile) {
        if (profile != null) {
            ...
            String[] testArray = getResources().getStringArray(R.array.sports);
            textViewSportname.setText(testArray[profile.getChooseSport()]);
            if(profile.getExperience1()){
                imageViewLevel.setImageResource(R.drawable.icon_level_red);
            }
            else if(profile.getExperience2()){
                imageViewLevel.setImageResource(R.drawable.icon_level_blue);
            }
            else if(profile.getExperience3()){
